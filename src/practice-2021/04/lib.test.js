...
describe('playBingo', () => {
  it('returns the score of the winning bingo card', () => {
    const parsedInput = parseInput(testData);
    const result = playBingo(parsedInput);
...
describe('findLastWinner', () => {
  it('returns the score of the last winning bingo card', () => {
    const parsedInput = parseInput(testData);
    const result = findLastWinner(parsedInput);
